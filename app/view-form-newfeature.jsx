// VIEW — New feature on a Page/Report
function ViewFormNewFeature({ go }) {
      ...
      <div className="formcol">
        ...
        {accordion && (
          <form className="reqform" onSubmit={(e) => { e.preventDefault(); go("requests"); }}>
            ...
            <Field label="Existing Report Name" required sub="Specify the name of the report where the new feature will be implemented.">
              <input className="txt" value={existingReport} onChange={(e) => setExistingReport(e.target.value)} />
            </Field>

            <Field label="Existing Page name" required sub="Specify the name of the report page where the new feature should be implemented.">
              <input className="txt" value={existingPage} onChange={(e) => setExistingPage(e.target.value)} />
            </Field>

            <Field label="Feature Description" required sub="Provide a detailed description of the new feature, including what it is and how it should function.">
              <input className="txt" value={featureDesc} onChange={(e) => setFeatureDesc(e.target.value)} />
            </Field>
            ...
            <Field label="Goal or Objective of the Feature" required sub="State why this request is needed and what business problem or question it solves.">
              <RTE variant="full" />
            </Field>
...
Object.assign(window, { ViewFormNewFeature });
